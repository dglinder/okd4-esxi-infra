...
resource "esxi_guest" "okd4-services" {
  ...
  network_interfaces {
    # Setup the home network NIC
    mac_address     = var.hn_to_homemac["okd4-services"] #"00:50:56:01:01:01"
...
resource "esxi_guest" "okd4-pfsense" {
  ...
  network_interfaces {
    # Setup the home network NIC
    mac_address     = var.hn_to_homemac["okd4-pfsense"] #"00:50:56:01:01:01"
    virtual_network = var.okd_network
    nic_type        = "vmxnet3"
  }
}
